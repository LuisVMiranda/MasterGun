...
const CORE_MISSION_ROWS = Object.freeze([
  ...
  row(THIRD_UPGRADE_SLOT_MISSION_ID, "levelReached", 80, ["Expanded Armory", "Reach level 80 to unlock a third upgrade offer."], ["Arsenal expandido", "Alcance o nível 80 para liberar uma terceira oferta de upgrade."], ["Arsenal ampliado", "Alcanza el nivel 80 para desbloquear una tercera mejora."]),
  ...
  row(FOURTH_UPGRADE_SLOT_MISSION_ID, "levelReached", 140, ["Quartermaster Elite", "Reach level 140 to unlock a fourth upgrade offer."], ["Intendente elite", "Alcance o nível 140 para liberar uma quarta oferta de upgrade."], ["Intendente de élite", "Alcanza el nivel 140 para desbloquear una cuarta mejora."]),
